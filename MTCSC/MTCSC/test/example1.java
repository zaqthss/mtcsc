...
import cn.edu.thu.MTCSC.TwoMILP;
import java.util.ArrayList;
import cn.edu.thu.MTCSC.EWMA;
import cn.edu.thu.MTCSC.QCQP;
import cn.edu.thu.MTCSC.Global_2;
import cn.edu.thu.MTCSC.MTCSC_QCQP;
import cn.edu.thu.MTCSC.MTCSC_2;
// import cn.edu.thu.MTCSC.MyGlobal;
...
public class example1 {
    public static void main(String[] args) {
        ...
        String outputdirectory = "example/";
        ...
        assist.saveDataFromTimeSeries2(outputdirectory+"QCQP.csv", resultSeries_two);

        // QCQP
        dirtySeries = assist.readData2(inputFileName, ",");
        QCQP globalGurobi = new QCQP(dirtySeries, S, 10000);
        ...
        // TwoMILP
        dirtySeries = assist.readData2(inputFileName, ",");
        TwoMILP tmilp = new TwoMILP(dirtySeries, S, 10000);
        ...
        // MyGlobal
        dirtySeries = assist.readData2(inputFileName, ",");
        Global_2 gt = new Global_2(dirtySeries, S);
        ...
        assist.saveDataFromTimeSeries2(outputdirectory+"MTCSC.csv", resultSeries_twoPlus);
        ...
        // Screen_1
        SCREEN MTCSC_1 = new SCREEN(dirtySeries_1, sMax_1, sMin_1, 5);
        long time3 = System.currentTimeMillis();
        TimeSeries resultSeries_1 = MTCSC_1.mainScreen();
        long time4 = System.currentTimeMillis();
        // Screen_2
        SCREEN MTCSC_2 = new SCREEN(dirtySeries_2, sMax_2, sMin_2, 5);
        ...
        assist.saveDataFromTimeSeries(outputdirectory+"SCREEN.csv", resultSeries_1, resultSeries_2);
