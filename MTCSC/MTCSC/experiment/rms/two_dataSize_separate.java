...
public class two_dataSize_separate {
    ...
    public static void main(String[] args) {
        String csvFile1 = "noise/two/tranAD_dataSize/separate/45000.csv";
        String csvFile2 = "noise/two/tranAD_dataSize/separate/re-pre_";
        ...
        for(int i=0; i<9; i++){
            ...
            for(int j=0; j<expTime; j++,seed++){
                csvFile2 = "noise/two/tranAD_dataSize/separate/re-pre_";
