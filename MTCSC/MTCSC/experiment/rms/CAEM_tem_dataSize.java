...
public class CAEM_tem_dataSize {

    public static void main(String[] args) {
        String csvFile1 = "noise/one/CAE-M_tem_results/45000.csv";
        String csvFile2 = "noise/one/CAE-M_tem_results/dataSize/renorm-pre_";
        ...
        for(int i=0; i<9; i++){
            ...
            for(int j=0; j<expTime; j++,seed++){
                csvFile2 = "noise/one/CAE-M_tem_results/dataSize/renorm-pre_";
