...
public class ILD_dataSize_separate {
    public static void main(String[] args) {
        ...
        if(isNormalize){
            String writefilename = "result/Two/TemHum/dataSize/separate/RMS_nor.csv";
            assist.writeCSV(writefilename, name, totalSize ,totalRMS);
            writefilename = "result/Two/TemHum/dataSize/separate/COST_nor.csv";
            assist.writeCSV(writefilename, name, totalSize ,totalCOST);
            writefilename = "result/Two/TemHum/dataSize/separate/NUM_nor.csv";
            assist.writeCSV(writefilename, name, totalSize ,totalNUM);
            writefilename = "result/Two/TemHum/dataSize/separate/TIME_nor.csv";
            assist.writeCSV(writefilename, name, totalSize ,totalTIME);
        }
        else{
            String writefilename = "result/Two/TemHum/dataSize/separate/RMS.csv";
            assist.writeCSV(writefilename, name, totalSize ,totalRMS);
            writefilename = "result/Two/TemHum/dataSize/separate/COST.csv";
            assist.writeCSV(writefilename, name, totalSize ,totalCOST);
            writefilename = "result/Two/TemHum/dataSize/separate/NUM.csv";
            assist.writeCSV(writefilename, name, totalSize ,totalNUM);
            writefilename = "result/Two/TemHum/dataSize/separate/TIME.csv";
            assist.writeCSV(writefilename, name, totalSize ,totalTIME);
        }
    }
}