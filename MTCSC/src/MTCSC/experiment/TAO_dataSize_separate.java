...
public class TAO_dataSize_separate {
    public static void main(String[] args) {
        ...
        if(isNormalize){
            String writefilename = "result/MultiDimension/"+directory+"/dataSize/separate/RMS_nor.csv";
            assist.writeCSV(writefilename, name, totalSize ,totalRMS);
            writefilename = "result/MultiDimension/"+directory+"/dataSize/separate/COST_nor.csv";
            assist.writeCSV(writefilename, name, totalSize ,totalCOST);
            writefilename = "result/MultiDimension/"+directory+"/dataSize/separate/NUM_nor.csv";
            assist.writeCSV(writefilename, name, totalSize ,totalNUM);
            writefilename = "result/MultiDimension/"+directory+"/dataSize/separate/TIME_nor.csv";
            assist.writeCSV(writefilename, name, totalSize ,totalTIME);
        }
        else{
            String writefilename = "result/MultiDimension/"+directory+"/dataSize/separate/RMS.csv";
            assist.writeCSV(writefilename, name, totalSize ,totalRMS);
            writefilename = "result/MultiDimension/"+directory+"/dataSize/separate/COST.csv";
            assist.writeCSV(writefilename, name, totalSize ,totalCOST);
            writefilename = "result/MultiDimension/"+directory+"/dataSize/separate/NUM.csv";
            assist.writeCSV(writefilename, name, totalSize ,totalNUM);
            writefilename = "result/MultiDimension/"+directory+"/dataSize/separate/TIME.csv";
            assist.writeCSV(writefilename, name, totalSize ,totalTIME);
        }
