...
public class TAO_errorRate_separate {
    public static void main(String[] args) {
        ...
        for(int i=0; i<10; i++){
            ...
            for(int j=0; j<expTime; j++, seed++){
                ...
                dirtySeries = assist.addNoiseN_maxmin_separate(dirtySeries, drate, seed, n);
                if(isNormalize){
        ...
        if(isNormalize){
            String writefilename = "result/MultiDimension/"+directory+"/errorRate/separate/RMS_nor.csv";
            assist.writeCSV(writefilename, name, totalDrate ,totalRMS);
            writefilename = "result/MultiDimension/"+directory+"/errorRate/separate/COST_nor.csv";
            assist.writeCSV(writefilename, name, totalDrate ,totalCOST);
            writefilename = "result/MultiDimension/"+directory+"/errorRate/separate/NUM_nor.csv";
            assist.writeCSV(writefilename, name, totalDrate ,totalNUM);
            writefilename = "result/MultiDimension/"+directory+"/errorRate/separate/TIME_nor.csv";
            assist.writeCSV(writefilename, name, totalDrate ,totalTIME);
        }
        else{
            String writefilename = "result/MultiDimension/"+directory+"/errorRate/separate/RMS.csv";
            assist.writeCSV(writefilename, name, totalDrate ,totalRMS);
            writefilename = "result/MultiDimension/"+directory+"/errorRate/separate/COST.csv";
            assist.writeCSV(writefilename, name, totalDrate ,totalCOST);
            writefilename = "result/MultiDimension/"+directory+"/errorRate/separate/NUM.csv";
            assist.writeCSV(writefilename, name, totalDrate ,totalNUM);
            writefilename = "result/MultiDimension/"+directory+"/errorRate/separate/TIME.csv";
            assist.writeCSV(writefilename, name, totalDrate ,totalTIME);
        }
