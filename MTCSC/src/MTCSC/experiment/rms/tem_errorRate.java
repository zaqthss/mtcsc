...
public class tem_errorRate {

    public static void main(String[] args) {
        String csvFile1 = "noise/one/FCVAE_pre_tem_result/errorRate/5000.csv";
        String csvFile2 = "noise/one/FCVAE_pre_tem_result/errorRate/";
        ...
        for(int i=0; i<10; i++){
            ...
            for(int j=0; j<expTime; j++,seed++){
                csvFile2 = "noise/one/FCVAE_pre_tem_result/errorRate/";
