...
public class tranAD_tem_errorRate {

    public static void main(String[] args) {
        String csvFile1 = "noise/one/TranAD_tem_results/5000.csv";
        String csvFile2 = "noise/one/TranAD_tem_results/errorRate/renorm-pre_";
        ...
        for(int i=0; i<10; i++){
            ...
            for(int j=0; j<expTime; j++,seed++){
                csvFile2 = "noise/one/TranAD_tem_results/errorRate/renorm-pre_";
