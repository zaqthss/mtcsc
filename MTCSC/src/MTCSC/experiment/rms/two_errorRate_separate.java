...
public class two_errorRate_separate {
    ...
    public static void main(String[] args) {
        String csvFile1 = "noise/two/tranAD_errorRate/separate/5000.csv";
        String csvFile2 = "noise/two/tranAD_errorRate/separate/re-pre_";
        ...
        for(int i=0; i<10; i++){
            ...
            for(int j=0; j<expTime; j++,seed++){
                csvFile2 = "noise/two/tranAD_errorRate/separate/re-pre_";
