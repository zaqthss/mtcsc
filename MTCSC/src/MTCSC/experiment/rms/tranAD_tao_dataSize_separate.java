...
public class tranAD_tao_dataSize_separate {

    public static void main(String[] args) {
        String csvFile1 = "noise/MultiDimension/tranAD_tao_result/tao_test.csv";
        String csvFile2 = "noise/MultiDimension/tranAD_tao_result/dataSize/separate/renorm-pre_";
        ...
        for(int i=0; i<10; i++){
            ...
            for(int j=0; j<expTime; j++,seed++){
                csvFile2 = "noise/MultiDimension/tranAD_tao_result/dataSize/separate/renorm-pre_";
