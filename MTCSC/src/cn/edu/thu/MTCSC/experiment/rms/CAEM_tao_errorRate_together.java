...
public class CAEM_tao_errorRate_together {

    public static void main(String[] args) {
        String csvFile1 = "noise/MultiDimension/CAE-M_tao_results/tao_test.csv";
        String csvFile2 = "noise/MultiDimension/CAE-M_tao_results/errorRate/together/renorm-pre_";
        ...
        for(int i=0; i<10; i++){
            ...
            for(int j=0; j<expTime; j++,seed++){
                csvFile2 = "noise/MultiDimension/CAE-M_tao_results/errorRate/together/renorm-pre_";
