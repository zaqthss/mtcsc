...
public class tem_dataSize {

    public static void main(String[] args) {
        String csvFile1 = "noise/one/FCVAE_pre_tem_result/dataSize/";
        String csvFile2 = "noise/one/FCVAE_pre_tem_result/dataSize/";
        ...
        for(int i=0; i<9; i++){
            ...
            csvFile1 = "noise/one/FCVAE_pre_tem_result/dataSize/";
            csvFile1 += String.valueOf(size) + ".csv";
            for(int j=0; j<expTime; j++,seed++){
                csvFile2 = "noise/one/FCVAE_pre_tem_result/dataSize/";
