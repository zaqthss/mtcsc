...
public class TAO_errorRate_together {
    public static void main(String[] args) {
        ...
        if(isNormalize){
            String writefilename = "result/MultiDimension/"+directory+"/errorRate/together/RMS_nor.csv";
            assist.writeCSV(writefilename, name, totalDrate ,totalRMS);
            writefilename = "result/MultiDimension/"+directory+"/errorRate/together/COST_nor.csv";
            assist.writeCSV(writefilename, name, totalDrate ,totalCOST);
            writefilename = "result/MultiDimension/"+directory+"/errorRate/together/NUM_nor.csv";
            assist.writeCSV(writefilename, name, totalDrate ,totalNUM);
            writefilename = "result/MultiDimension/"+directory+"/errorRate/together/TIME_nor.csv";
